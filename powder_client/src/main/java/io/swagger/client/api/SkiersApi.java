...
public class SkiersApi {
     ...
     */
    public Integer getSkierDayVertical(String resortID, String dayID, String skierID) throws ApiException {
        ApiResponse<Integer> resp = getSkierDayVerticalWithHttpInfo(resortID, dayID, skierID);
        return resp.getData();
    }
     ...
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public ApiResponse<Integer> getSkierDayVerticalWithHttpInfo(String resortID, String dayID, String skierID) throws ApiException {
     ...
     */
    public com.squareup.okhttp.Call getSkierDayVerticalAsync(String resortID, String dayID, String skierID, final ApiCallback<Integer> callback) throws ApiException {
